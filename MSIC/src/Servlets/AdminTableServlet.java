...
public class AdminTableServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
    {
        ...
        try
        {
            resp.getWriter().print(gson.toJson(sqlcmd.getAdmins("select * from " + sqlcmd.schemaName + ".ADMINISTRATOR order by email")));
        }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
    {
        ...
        switch (operation) {
            case "changepassword":
                ...
                query = "update " + sqlcmd.schemaName + ".ADMINISTRATOR set parola='" + req.getParameter("password") + "' where email='" +
            ...
            case "delete":
                ...
                query = "delete from " + sqlcmd.schemaName + ".ADMINISTRATOR where email='" + req.getParameter("email") + "'";
                result = "Administratorul a fost sters";
